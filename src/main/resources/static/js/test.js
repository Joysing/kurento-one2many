...
ws.onmessage = function(message) {
	...
	case 'existingParticipants':
		if(parsedMessage.accountType==='TEACHER'){
            presenter();
		}else{
		    if(parsedMessage.accountType==='repeatTeacher')
		        alert("Dear "+parsedMessage.name+":A teacher has already been in the room, and you will join the room as a student.");
			viewer();
		}
	...
	case 'newParticipantArrived':
	    ...
	    document.getElementById("onlineCount").innerHTML="当前在线人数："+parsedMessage.count;
	    break;
